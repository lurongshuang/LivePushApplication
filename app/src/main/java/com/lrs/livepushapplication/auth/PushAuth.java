package com.lrs.livepushapplication.auth;
...
public class PushAuth {
    ...
    private final static String PUSH_URL = "rtmp://39.100.237.137:1935";
    ...
    private static String getStreamName() {
        ...
        SharedPreferences sharePref = Application.getApplication().getApplicationContext().getSharedPreferences(PRE_GROUP, Context.MODE_PRIVATE);
        if (sharePref != null) {
