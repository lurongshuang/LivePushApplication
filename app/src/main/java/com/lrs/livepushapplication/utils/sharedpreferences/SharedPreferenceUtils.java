package com.lrs.livepushapplication.utils.sharedpreferences;
...
public class SharedPreferenceUtils {
    ...
    private static final String INIT_BIT = "init_bit";
    ...
    private static final String FPS_BIT = "fps_bit";
    private static final String AUDIOSAMEPLERATE = "audioSamepleRate";
    private static final String AUDIOPROFILE = "audioProFile";
    private static final String AUDICHANNELS = "AudioChannels";
    private static final String ORIENTATION = "orienTation";
    private static final String LIVETYPE = "liveType";
    private static final String QUALITYMODE = "qualityMode";
    ...
    public static void setAudioSamepleRate(Context context, int min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(AUDIOSAMEPLERATE, min);
        editor.commit();
    }

    public static int getAudioSamepleRate(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int min = sharedPreferences.getInt(AUDIOSAMEPLERATE, 0);
        return min;
    }

    public static void setAudioProFile(Context context, int min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(AUDIOPROFILE, min);
        editor.commit();
    }

    public static int getAudioProFile(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int min = sharedPreferences.getInt(AUDIOPROFILE, 0);
        return min;
    }

    public static void setAudioChannels(Context context, int min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(AUDICHANNELS, min);
        editor.commit();
    }
    ...
    public static int getAudioChannels(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int min = sharedPreferences.getInt(AUDICHANNELS, 0);
        return min;
    }

    public static void setQualityMode(Context context, int min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(QUALITYMODE, min);
        editor.commit();
    }

    public static int getQualityMode(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int min = sharedPreferences.getInt(QUALITYMODE, 0);
        return min;
    }

    public static void setOrienTation(Context context, String min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putString(ORIENTATION, min);
        editor.commit();
    }
    ...
    public static String getOrienTation(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        String min = sharedPreferences.getString(ORIENTATION, "ORIENTATION_PORTRAIT");
        return min;
    }

    public static void setLiveType(Context context, int min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(LIVETYPE, min);
        editor.commit();
    }

    public static int getLiveType(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int min = sharedPreferences.getInt(LIVETYPE, 0);
        return min;
    }

    public static void setDefinition(Context context, String min) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putString(DEFINITION, min);
        editor.commit();
    }
    ...
    public static String getDefinition(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        String min = sharedPreferences.getString(DEFINITION, "RESOLUTION_540P");
        return min;
    }

    public static void setInitBit(Context context, int init) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putInt(INIT_BIT, init);
        editor.commit();
    }

    public static int getInitBit(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        int init = sharedPreferences.getInt(INIT_BIT, 0);
        return init;
    }

    public static void setFpsBit(Context context, String fps) {
        SharedPreferences mySharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE, Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = mySharedPreferences.edit();
        editor.putString(FPS_BIT, fps);
        editor.commit();
    }

    public static String getFpsBit(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        String init = sharedPreferences.getString(FPS_BIT, "FPS_8");
        return init;
    }
    ...
    public static boolean getBeautyOn(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHAREDPRE_FILE,
                Activity.MODE_PRIVATE);
        boolean bt = sharedPreferences.getBoolean(BEAUTYON, true);
        return bt;
    }
